...
1. **Все алгоритмы демонстрируют сложность O(n log n)**, что подтверждается графиками зависимости времени выполнения от размера входных данных.

2. **Алгоритм Хаффмана** является самым медленным из трех, что объясняется:
...
3. **Задача о выборе заявок** показывает лучшую производительность благодаря:
   - Простой структуре данных (список интервалов)
   - Однократной сортировке и линейному обходу
   - Минимальным накладным расходам

4. **Непрерывный рюкзак** также демонстрирует высокую эффективность:
   - Только сортировка и линейный обход
...
1. **Когда использовать жадные алгоритмы**:
