...
**Итог:** DJB2 и полиномиальная функция показали одинаковый минимальный уровень коллизий, что характерно для качественных хеш-функций.  
...
Ниже представлены данные из запуска программы.
...
**Итог:** выбор реализации хеш-таблицы зависит от требований к памяти, устойчивости к коллизиям и допустимой плотности таблицы.
